...
# pixels large.
html_favicon = 'es/_static/favicon.ico'

# Add any paths that contain custom static files (such as style sheets) here,
# relative to this directory. They are copied after the builtin static files,
# so a file named "default.css" will overwrite the builtin "default.css".
html_static_path = ['../es/_static']
...
texinfo_documents = [
  ('index', 'PhalconDocumentation', 'Phalcon Framework Documentation',
   'Phalcon Team', 'PhalconDocumentation', 'Phalcon es un framework entregado como una extensión de C mejorando el rendimiento', 'Miscellaneous'),
]
